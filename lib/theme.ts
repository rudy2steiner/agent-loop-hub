...
export function defaultThemeForPath(pathname: string): Theme {
  ...
  if (
    pathname === "/agent-loop-generator" ||
    pathname === "/loop-readiness-checker" ||
    pathname === "/what-is-loop-engineering"
  ) return "light";
